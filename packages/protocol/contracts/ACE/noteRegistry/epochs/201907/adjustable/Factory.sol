...
contract FactoryAdjustable201907 is NoteRegistryFactory {
      ...
      returns (address)
    {
        ...
        BehaviourAdjust201907 behaviourContract = new BehaviourAdjust201907(address(dataContract));
    ...
    function deployNewBehaviourInstance(
      ...
      returns (address)
    {
        BehaviourAdjust201907 behaviourContract = new BehaviourAdjust201907(_dataContractAddress);
        behaviourContract.transferOwnership(msg.sender);
        emit NoteRegistryDeployed(address(behaviourContract));
        return address(behaviourContract);
    }
