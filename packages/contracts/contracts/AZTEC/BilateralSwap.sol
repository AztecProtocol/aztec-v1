...
contract BilateralSwap {
    ...
    function() external payable {
        assembly {
            ...
            // We still assume calldata is offset by 4 bytes so that we can represent this contract through a comp\atible ABI
            ...
            function validateBilateralSwap() {
                ...
                */
                ...
                let b := add(0x300, mul(n, 0x80)) // setting the pointer to the location in memory where the commitments end
