...
/**
 * Extract the witnesses for two proof transcripts over the same input string but with different challenges. We use this
 * to validate the soundness of our implementation in the random oracle model.
 *
 ...
 * @returns {Object[]} the AZTEC notes used in the proof, with their extracted witnesses (the note value and note
 * viewing key)
 */
