...
const { TradeProof } = require('../../../src/proof-v2');

describe.only('Trade Proof', () => {
    let inputNotes = [];
    ...
    it('should construct a Trade proof with well-formed outputs', async () => {
        const proof = new TradeProof(inputNotes, outputNotes, sender);
    ...
    it('should construct a Trade proof where blinding scalar relations are satisfied', async () => {
