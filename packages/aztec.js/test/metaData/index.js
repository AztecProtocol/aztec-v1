...
describe('Metadata', () => {
    ...
    describe('Success states', async () => {
        it('should create metadata for multiple notes when metadata has been set', async () => {
            ...
            testNoteA.setMetadata(note.utils.customMetadata);
            testNoteB.setMetadata(note.utils.customMetadata);
            ...
            for (let i = 0; i < numNotes; i += 1) {
                ...
                expect(recoveredCustomData).to.equal(padLeft(note.utils.customMetadata, 64));
            }
        });
    });
});
