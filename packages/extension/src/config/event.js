...
export const subscriptionRequestEvent = 'aztec-subscription';
export const subscriptionResponseEvent = 'aztec-subscription-response';
export const subscriptionRemoveEvent = 'aztec-subscription-cancel';
