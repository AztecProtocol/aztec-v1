...
import { fontSizeMap, fontWeightMap } from '../../src/config/typography';
...
export const ReactComponentRenderer = ({
    ...
    <div id={`${name}-container`} className={classes.root}>
        ...
        {tabButtons && <div className={classes['tab-buttons']}>{tabButtons}</div>}
        {tabBody && <div className={classes['tab-body']}>{tabBody}</div>}
