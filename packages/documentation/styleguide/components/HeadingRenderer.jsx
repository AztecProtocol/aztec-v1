...
import { spacingMap, defaultTextColor, fontSizeMap, lineHeightMap, fontWeightMap } from '../../src/styles/guacamole-vars';
...
function HeadingRenderer({ classes, level, children, ...props }) {
    const Tag = `h${level}`;
    const headingClasses = classnames(classes.heading, classes[`heading${level}`]);
