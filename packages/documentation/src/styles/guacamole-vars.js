...
export const defaultLabelColorName = 'grey-dark';
export const defaultLabelColor = 'rgba(0, 0, 0, 0.7)';
...
export const calendarHoveredColor = 'rgba(2, 1, 8, 0.88)';
...
export const buttonSizeKeys = ['xxs', 'xs', 's', 'm', 'l', 'xl', 'xxl'];
