import dataKey, { getPrefix } from '../src/dataKey';

let warnings = [];
const consoleSpy = jest.spyOn(console, 'warn').mockImplementation((message) => warnings.push(message));
