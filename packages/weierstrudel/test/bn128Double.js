...
const Bn128Double = artifacts.require('../contracts/Bn128Double');
const Bn128DoubleInterface = artifacts.require('../contrats/Bn128DoubleInterface');

const bn128Reference = require('../js_snippets/bn128_reference.js');

Bn128Double.abi = Bn128DoubleInterface.abi; // hon hon hon
contract('Bn128Double', (accounts) => {
    let contract;
    beforeEach(async () => {
        contract = await Bn128Double.new();
    });
